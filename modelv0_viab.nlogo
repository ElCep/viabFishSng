;; un parceur pour récuper les valeurs qui arrive d'openMole
extensions [csv gis]
__includes["parceur.nls"]
breed [boats boat]
breed [villages village]

globals [
  ;; valeur injecter from input depuis OM
  nbPirogues_l
  nbClosed_l
  reserve_l
  monthCounter ; count  30 day by month
